<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.html" class="app-brand-link">
            ...
            <img src="{{ asset('assets/img/favicon/favicon.ico') }}" class="app-brand-logo rounded demo" width="50" alt="">
            <span class="app-brand-text demo menu-text fw-bolder ms-2">KLR</span>
        </a>
